...
void HAL_PCD_MspInit(PCD_HandleTypeDef* pcdHandle) {
    if(pcdHandle->Instance==USB) {
        ...
        // PA11/PA12 are USB. Remap might be needed depending on board, but standard BluePill uses PA11/12 directly.
        // Also ensure USB Pull-up on PA12 (DP) is enabled. BluePill has R10 1.5k or 10k often wrong.
        // Assuming standard setup.

        // Enable GPIOA clock just in case
